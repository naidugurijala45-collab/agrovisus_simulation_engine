...
class ReportingService:
    def __init__(self, data_manager, soil_model, crop_model, nutrient_model, disease_model, rule_evaluator):
    ...
    def get_daily_report_data(self, current_date, daily_weather, daily_irrigation_mm, daily_fertilization_events, triggered_rules_for_day):
        """
        ...
        data = {
            ...
            "daily_avg_temp_c": daily_weather.get('avg_temp_c'), # Use .get() for safety
            ...
            "daily_fertilization_kg_ha": sum(f['amount_kg_ha'] for f in daily_fertilization_events) if daily_fertilization_events else 0.0,
            ...
            # Stress Factors
            "overall_stress_factor": min(self.crop_model.nitrogen_stress_factor, self.crop_model.water_stress_factor, self.disease_model.get_disease_stress_factor()),
            ...
            # Rule Evaluator Data
            "triggered_rules": ", ".join(triggered_rules_for_day) if triggered_rules_for_day else "",
        }
        return data
