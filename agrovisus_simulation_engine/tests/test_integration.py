...
class TestCropTemplateAvailability:
    ...
    def test_all_templates_loadable(self):
        ...
        for name in templates:
            ...
            assert "t_base_c" in t, f"Template '{name}' missing t_base_c"
            assert "harvest_index" in t, f"Template '{name}' missing harvest_index"
            assert "gdd_thresholds" in t, f"Template '{name}' missing gdd_thresholds"
